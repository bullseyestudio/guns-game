...
def isSystemDLL(pathname):
    ...
    if os.path.basename(pathname).lower() in ("libfreetype-6.dll", "libogg-0.dll",
            'zlib1.dll', 'sdl.dll', 'sdl_ttf.dll', 'fftpack_lite.pyd'):
            return 0
...
class BuildExe:
    def __init__(self):
        ...
        self.license = "Unknown Open-Source"

        #Auhor of program
        self.author_name = "Bull's Eye! Studio"
        self.author_email = "bullseye@narc.ro"
        self.copyright = "Copyright (c) 2011 Bull's Eye! Studio."

        #Description
        self.project_description = "Guns! the tank game."

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ['data', 'default']
